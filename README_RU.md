...
Это самый простой вариант, если вам нужно только запустить SNNLab. Wheel содержит упакованный код проекта; `pip` устанавливает его в Python-окружение и создаёт команду `snnlab-gui`.
