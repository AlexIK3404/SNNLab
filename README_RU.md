...
- Боковое меню уровней и рабочая область **абляции на одном нейроне**: event-corrected
...
Методика и формат результатов первого уровня описаны в
...
- Уровень численного исследования одного нейрона реализован; уровни фиксированной
