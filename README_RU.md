...
- Боковое меню разделов и рабочая область **абляции на одном нейроне**: event-corrected
  reset порога, траектории, f-I-кривые, сходимость ISI, дрейф времени спайков,
  вычислительная стоимость, контрольный grid reset и сравнение вещественной/комплексной
  двухшаговой композиции Эйлера.
...
Методика и формат результатов исследования одного нейрона описаны в
...
- Численные эксперименты с одним нейроном реализованы; исследования фиксированной
  популяции, пластичности и итоговой задачи с повторными seed запланированы.
